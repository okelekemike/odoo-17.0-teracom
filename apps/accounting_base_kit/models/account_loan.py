...
class AccountLoan(models.Model):
    ...
    periods = fields.Integer(
        required=True,
        help="Number of repayment periods that the loan will last",
    )
    ...
    rate_period = fields.Float("Rate Period (%)",
    ...
    round_on_end = fields.Boolean(
        ...
        ", if it is unchecked, the annuity will be recalculated on each period.",
    )
