...
class BonusRequest(models.Model):
    ...
    credit_account_id = fields.Many2one('account.account',
                                        ...
                                        help='The credit account for creating journal entry')
    debit_account_id = fields.Many2one('account.account',
                                       string='Debit Account',
                                       help='The debit account for creating journal entry')
    ...
    def create(self, vals_list):
        ...
        res = super(BonusRequest, self).create(vals_list)
        return res
...
class HrPayslip(models.Model):
    ...
    def _onchange_employee_id(self):
        ...
        bonus_rule = self.env.ref(
            'accounting_base_kit.hr_salary_rule_bonus')
