...
class ReportBalanceLeave(models.Model):
    ...
    emp_id = fields.Many2one('hr.employee', string="Employee", readonly=True, help="Employee name")
    gender = fields.Char(string='gender', readonly=True, help="Employee Gender")
    department_id = fields.Many2one('hr.department', string='Department', readonly=True, help="Department Name")
    country_id = fields.Many2one('res.country', string='Nationality', readonly=True, help="Country Name")
    job_id = fields.Many2one('hr.job', string='Job', readonly=True, help="Job of employee")
    leave_type_id = fields.Many2one('hr.leave.type', string='Leave Type', readonly=True, help="Leave type of employee")
    allocated_days = fields.Integer(string='Allocated Balance', help="Total leave assigned to the employee")
    taken_days = fields.Integer(string='Taken Leaves', help="Taken leaves of employee")
    balance_days = fields.Integer(string='Remaining Balance', help="Remaining leaves of employee")
