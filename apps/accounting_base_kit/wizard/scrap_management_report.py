...
class ScrapManagementReport(models.TransientModel):
    ...
    def action_print_pdf(self):
        ...
        if self.filter == 'product_wise':
            ...
            return self.env.ref(
                'accounting_base_kit.action_scrap_management_product_wise').report_action(
                None,
                data=data)
        if self.filter == 'state_wise':
            ...
            return self.env.ref(
                'accounting_base_kit.action_scrap_management_state_wise').report_action(None, data=data)
