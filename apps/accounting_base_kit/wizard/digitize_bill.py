...
class DigitizeBill(models.TransientModel):
    ...
    def record_lines(self, product_lines_newline_name_qty_price_amount,
        ...
        if (product_lines_newline_name_qty_price_amount or
            ...
            products = [self.env['product.product'].search([('name', '=', line[0])], limit=1) or
            ...
            price = [line[2] for line in product_lines_newline_name_qty_price_amount]
    ...
    def action_add_document(self):
        ...
        try:
            ...
            resized_img = img.resize((img.width * 2, img.height * 2), resample=Image.BICUBIC)
        except Exception:
