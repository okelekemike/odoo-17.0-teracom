...
class HrGenerateShift(models.Model):
    ...
    _description = 'Employee Shift Generation'

    hr_department = fields.Many2one('hr.department', string="Department", help="Department")
    start_date = fields.Datetime(string="Start Date", required=True, help="Start date")
    end_date = fields.Datetime(string="End Date", required=True, help="End date")
