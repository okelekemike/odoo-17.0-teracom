...
class ResConfigSettings(models.TransientModel):
    ...
    def COLOR_ASSET_LIGHT_URL(self):
        return '/teracom_web_colors/static/src/scss/colors_light.scss'
    ...
    def COLOR_ASSET_DARK_URL(self):
        return '/teracom_web_colors/static/src/scss/colors_dark.scss'
    ...
    def COLOR_ASSET_THEME_URL(self):
        return '/teracom_web_theme/static/src/scss/colors.scss'
